...
enemy_laser_sound = pygame.mixer.Sound("LASRLIT1.wav")
...
class Enemy(Ship):
    color_map = {"red": (red_ship, red_laser), "green": (green_ship, green_laser), "blue": (bule_ship, blue_laser)}
...
def main():
    ...
    while run:
        ...
        for enemy in enemies[:]:
            ...
            if random.randrange(0, 2 * 60) == 1 and HEIGHT >= 0:  # jak zrobic zeby strzelali tylko w polu gry???
                enemy.shoot()
                # enemy_laser_sound.play()
